...
<div class="admin-card" style="max-width: 600px; margin: 0 auto;">
    <h3 class="card-title" style="margin-bottom: 24px;"><i class="fas fa-plus-circle"></i> Agregar Nueva Categoría</h3>
    ...
    <form action="/admin/categorias/crear" method="POST">
        ...
        <div class="form-group">
            ...
            <textarea id="descripcion" 
                      ...
                      class="form-control" 
                      rows="4" 
                      placeholder="Breve descripción sobre los temas que abordará esta categoría..."><?= htmlspecialchars(old('descripcion')) ?></textarea>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" 
                   ...
                   min="1" 
                   step="0.1"
                   value="<?= htmlspecialchars(old('puntaje_maximo') ?: '20') ?>" 
                   required>
        ...
        <div class="form-actions">
            ...
            <button type="submit" class="btn btn-primary btn-submit">Guardar Categoría</button>
        </div>
    </form>
</div>
